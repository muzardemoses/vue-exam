<template>
  <div class="bg-white pt-60 px-28 lg:px-8 md:px-4 pb-20">
    <div class="bg-gray-50 py-10 px-20 rounded-lg flex flex-col lg:px-6">
      <div class="flex justify-between items-center">
        <h2 class="text-3xl font-bold mb-4 flex gap-2 items-center">
          Cart
          ...
          <div class="flex justify-between">
            <div class="flex gap-8">
              ...
              <div class="flex flex-col justify-center gap-1">
                <h2 class="text-2xl font-medium capitalize text-gray-600 mb-2">
                  {{ item.name }}
                </h2>
            ...
            <div class="flex flex-col justify-center gap-3">
              <h3 class="text-3xl font-semibold capitalize text-right">
                ${{ (item.price * item.quantity).toLocaleString()  }}
              </h3>
              <div class="flex items-center gap-2">
                <p class="text-base font-semibold text-gray-400 line-through">
                  ${{ item.originalPrice.toLocaleString()  }}
                </p>
                <span
                  class="text-sm font-semibold bg-green-500 text-white py-1.5 px-2 rounded-lg"
                >
                  save ${{ item.amountSaved.toLocaleString()  }}
                </span>
              </div>
              <span class="text-lg font-semibold text-gray-400 text-right">
